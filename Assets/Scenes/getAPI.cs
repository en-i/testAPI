...
public class getAPI : MonoBehaviour {
    ...
    IEnumerator Upload () {
        ...
        if (www.isNetworkError || www.isHttpError) {
            ...
            machine.Add (new MultipartFormDataSection ("Authorization: Bearer " + inputJson.accessToken));
            Debug.Log(inputJson.accessToken);
            UnityWebRequest mw = UnityWebRequest.Post ("https://tra.mimi.fd.ai/machine_translation", machine);
            mw.SetRequestHeader ("text", "%E3%81%93%E3%82%93%E3%81%AB%E3%81%A1%E3%81%AF");
            mw.SetRequestHeader ("source_lang", "ja");
            mw.SetRequestHeader ("target_lang", "en");
